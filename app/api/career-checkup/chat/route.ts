...
import { CAREER_CHECKUP_PROMPT } from '@/lib/prompts/career-checkup';
...
export async function GET() {
  try {
    ...
    console.error('career-checkup GET error:', error);
    return Response.json({ messages: [] });
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('career-checkup chat error:', error);
